# Load Household Consumption Data into R, subset it, and create histogram of Global Active Power
# over selected time frame.
...
# Create Histogram
hist(hcp_target$Global_active_power, col = "red", 
